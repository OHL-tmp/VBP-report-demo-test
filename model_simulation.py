...
result_ori=pd.read_csv('data/pharma_simulate.csv')
...
#            meas_recom_af_row.append(11)
	...
	setup_all.iloc[1,[10,11]]= [round(df_recom_measure.iloc[0,2],0),df_recom_measure.iloc[0,2]*0.95]
	...
	setup_all.iloc[2,[10,11]]= [round(df_recom_measure.iloc[2,2],0),df_recom_measure.iloc[2,2]*0.95]
...
#    setup_all['Cohort']='All CHF Patients'
	...
	setup_af.iloc[1,[10,11]]= [round(df_recom_measure.iloc[1,2],0),df_recom_measure.iloc[1,2]*0.95]
	...
	setup_af.iloc[2,[10,11]]= [round(df_recom_measure.iloc[3,2],0),df_recom_measure.iloc[3,2]*0.95]
...
#    setup=pd.concat([setup_all,setup_af])
	...
	df_recom_measure.iloc[[0,1,2,3],[2,4]]=round(df_recom_measure.iloc[[0,1,2,3],[2,4]],0)
	df_recom_measure.iloc[[4,5,6,7],[2,4]]=round(df_recom_measure.iloc[[4,5,6,7],[2,4]],2)
	df_recom_measure.iloc[:,[3]]=round(df_recom_measure.iloc[:,[3]],2)
